    ...
    <div className="flex flex-col gap-8 items-center justify-center mt-12">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-16">
            ...
            <div className="w-full lg:w-5/12 h-max shadow-lg border-1 border-gray-100 p-8 rounded-lg flex flex-col gap-8">
                ...
                {activeStep === 1 &&
                <button onClick={() => router.push('/cart?step=2' , {scroll: false})}  className="w-full bg-gray-800 hover:bg-gray-900 transition-all duration-300 text-white rounded-lg p-2 cursor-pointer flex items-center justify-center gap-2">
                    Continue
